...
import { createPublicClient, http, createWalletClient, parseEther, formatEther, toHex } from "viem";
...
async function mintTokens() {
  ...
  if (args.length !== 2) {
    throw new Error("Usage: ts-node mintTokens.ts <recipient_address> <token_amount>");
  }
